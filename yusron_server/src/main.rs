...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let influx_url = "http://localhost:8086/api/v2/write?org=yusron&bucket=yusron&precision=s";
    let token = "4WIRFULT3vEtEIfQdJ1HjwTdd1-SirLsVsEOkd6h4OCAWI0EM6trEGzTOi6I5BMN0gXEB_kNfTp7ykxurfuHxA==";
